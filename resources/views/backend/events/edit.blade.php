...
<div id="page-wrapper">
    <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <h1 class="page-header">Edit Event - {{ $adminevent->title }} <span></h1>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            @if($permissiondata->contains('events.edit') || $userdata->id == 1)
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <form role="form" style="padding:1rem 2rem;" method="post" action="{{ route('admin.dashboard.events.update', $adminevent->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ $adminevent->title }}">
                                        @error('title')
                                    ...
                                    <div class="form-group banner-image-field">
                                        ...
                                        <img id="featured_image_src" src="{{ url('/backend/images/events_images') }}/{{ $adminevent->image }}" alt="{{ $adminevent->title }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control  @error('description') is-invalid @enderror" id="description" name="description">{{ $adminevent->description }}</textarea>
                                    </div>
                                   
                                    <div class="form-group">
                                        <label>Venue</label>
                                        <input class="form-control @error('venue') is-invalid @enderror" id="venue" name="venue" value="{{ $adminevent->venue }}">
                                        @error('venue')
                                            <div class="formAlertError alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="datecal">
                                        <input type="text" placeholder="Select Date"  class="form-control @error('startdate') is-invalid @enderror" id="from" name="startdate" value="{{ $adminevent->startdate }}">
                                        </span>
                                        @error('startdate')
                                            <div class="formAlertError alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="datecal">
                                        <input type="text" placeholder="Select Date" class="form-control @error('enddate') is-invalid @enderror" id="to" name="enddate" value="{{ $adminevent->enddate }}">
                                        </span>
                                        @error('enddate')
                                            <div class="formAlertError alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="timepickerinput">
                                            <div class='input-groups time'>
                                                <input type='text' name="starttime" placeholder="Click to pick time" id="myDatePicker" class="myDatePicker1 form-control" value="{{ $adminevent->starttime }}"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="timepickerinput">
                                            <div class='input-groups time'>
                                                <input type='text' name="endtime" placeholder="Click to pick time" id="myDatePicker2" class="myDatePicker2 form-control" value="{{ $adminevent->endtime }}"/>
                                    ...
                                    <div class="form-group">
                                        <label>Price</label>
                                        <input class="form-control @error('price') is-invalid @enderror" id="price" name="price" value="{{ $adminevent->price }}">
                                        @error('price')
                                            <div class="formAlertError alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('buttonlink') is-invalid @enderror" id="buttonlink" name="buttonlink" value="{{ $adminevent->buttonlink }}">
                                        @error('buttonlink')
                                            <div class="formAlertError alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('buttontext') is-invalid @enderror" id="buttontext" name="buttontext" value="{{ $adminevent->buttontext }}">
                                        @error('buttontext')
                                            <div class="formAlertError alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control" id="status">
                                            <option value="Published" {{$adminevent->status == "Published" ? "selected" : ""}}>Published</option>
                                            <option value="Draft" {{$adminevent->status == "Draft" ? "selected" : ""}}>Draft</option>
                                        </select>
                                    </div>
