...
@section('title', 'Admin | Add On Demand Course')
@section('content')
<div id="page-wrapper">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <form role="form" style="padding:1rem 2rem;" method="post" action="{{ route('admin.dashboard.ondemand.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <label>Excerpt</label>
                                        <textarea class="form-control @error('excerpt') is-invalid @enderror" id="description" name="excerpt">{{old('excerpt')}}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="ondemand_category" id="ondemand_category" class="form-control @error('ondemand_category') is-invalid @enderror" id="ondemand_category">
                                            ...
                                            <option value="{{ $adminondemandcat->id }}">{{ $adminondemandcat->title }}</option>
                                            @endforeach
                                        </select>
                                        @error('ondemand_category')
                                            <div class="formAlertError alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="subscription" id="subscription" class="form-control @error('subscription') is-invalid @enderror" id="subscription">
                                            ...
                                            <option value="{{ $adminsubscription->id }}">{{ $adminsubscription->title }}</option>
                                            @endforeach
                                        </select>
                                        @error('subscription')
                                            <div class="formAlertError alert alert-danger">{{ $message }}</div>
                                        ...
                                        <div class="liveStreamInputs">
                                            <div class="timepickerinput">
                                                <div class='input-groups time'>
                                                    <input type='text' name="scheduletime" placeholder="Click to pick time" id="myDatePicker" class="form-control" value="{{old('scheduletime')}}"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('embed_url') is-invalid @enderror" id="embed_url" name="embed_url" style="height: 120px;font-weight:700;"> <iframe width="560" height="315" src="https://www.youtube.com/embed/D0UnqGm_miA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                        </textarea>
                                    </div>
                                    @error('embed_url')
                                        <div class="formAlertError alert alert-danger">{{ $message }}</div>
