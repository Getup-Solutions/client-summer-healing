...
@section('title', 'Admin | Edit Admin Permission')
@section('content')
<div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <h1 class="page-header">Admin Permission Edit
                        </h1>
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    @endif
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <form role="form" style="padding:1rem 2rem;" method="post" action="{{ route('admin.dashboard.admin.permission.update', $permission->id) }}">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('info') is-invalid @enderror" id="info" name="info" value="{{ $permission->info }}">
                                        @error('info')
                                            <div class="formAlertError alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
