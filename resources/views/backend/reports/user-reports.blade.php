...
<div id="page-wrapper">
    <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <h1 class="page-header">Subscribed Users List
                            <span>
             ...
             <div class="row filterOptions">
                <div class="col-lg-12 col-md-12">
                  <form method="get" action="/admin/user-reports">
            ...
            @endphp
            @if($permissiondata->contains('reports.index') || $userdata->id==1)
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12 col-md-12">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="main_page_title">{{ $user->email }}</td>
                                        <td class="main_page_title">Subscriber</td>
                                        <td class="main_page_title">{{ Carbon\Carbon::parse($user->created_at)->format('d-m-Y')}}</td>
                                        <td>
                                            <ul class="actionList">
