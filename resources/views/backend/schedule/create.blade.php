...
@section('title', 'Admin | Add Schedule')
@section('content')
...
<div id="page-wrapper">
    <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <h1 class="page-header">Add Schedule <span></h1>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <form role="form" style="padding:1rem 2rem;" method="post" action="{{ route('admin.dashboard.schedules.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('embed_url') is-invalid @enderror" id="embed_url" name="embed_url" style="height: 120px; font-weight:700;">{{old('embed_url')}}</textarea>
