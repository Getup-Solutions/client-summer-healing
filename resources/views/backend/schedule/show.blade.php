...
@section('title', 'Admin | View Schedule Item')
@section('content')
<div id="page-wrapper">
    <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <h1 class="page-header">View {{ $schedule->user_name }} <span></h1>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        @php
                                            $details = App\Models\Adminschedule:
                                        @endphp
                                        <tbody>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><img style="width:100px;" src="{{ url("/backend/images/schedules_images") }}/{{ $schedule->featured_image }}" alt="{{ $schedule->featured_image }}"></td>
                                            </tr>
                                            <tr>
