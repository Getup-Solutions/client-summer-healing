...
@section('title', 'Admin | Add Course Category')
@section('content')
<div id="page-wrapper">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <form role="form" style="padding:1rem 2rem;" method="post" action="{{ route('admin.dashboard.admincoursecategories.store') }}" enctype="multipart/form-data">
                                    @csrf
