...
@section('title', 'Admin | Add Subscription')
@section('content')
<div id="page-wrapper">
    <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <h1 class="page-header">Add Subscription <span></h1>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            @if($permissiondata->contains('subscriptions.create') && $permissiondata->contains('subscriptions.index') || $userdata->id == 1)
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <form role="form" style="padding:1rem 2rem;" method="post" action="{{ route('admin.dashboard.subscription.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group" id="intvalField">
