...
@section('content')
@section('title', 'Schedule - '.$schedule->title)
...
@endif
 ...
 <section class="spacing-150">
    <div class="container-fluid text-center">
        ...
        <div class="row">
          <div class="col-md-6 col-12 left-desc-col">
          ...
          <div class="col-md-6 mt-5 col-12 right-payment-col">
            <h2>Payment Details</h2>
            <h4>Amount: {{ $schedule->price == 0 ? "Free" : "$".$schedule->price }}</h4>
            <br/><br/>
            <form name="ajax-sub-form" id="ajax-sub-form" method="post" action="{{route('page.schedule.booksend', $schedule->id) }}#success_order">
                @csrf
                <div class="row justify-content-center">
                    <div class="col-xl-10">
                        ...
                        <input type="hidden" name="user_email" value="@if(auth()->check()){{ auth()->user()->email }}@endif">
                        <input type="hidden" name="user_phone" value="@if(auth()->check()){{ auth()->user()->phone }}@endif">
                        <input type="hidden" name="user_name" value="@if(auth()->check()){{ auth()->user()->name }}@endif">
        ...
        <div class="modal-content p-4">
            ...
            <div class="modal-body">
                ...
                <div id="login" class="activetabcontent tabcontentItem">
                    ...
                    <form action="{{ route('page.schedule.login') }}" method="POST" id="handleAjax" autocomplete="off">
                        @csrf
                ...
                <div id="register" class="tabcontentItem">
                    ...
                    <form action="{{ route('page.schedule.register') }}" method="POST" id="handleAjax2">
                        @csrf
                            <div class="form-group">
                                {{-- <label>Name</label> --}}
