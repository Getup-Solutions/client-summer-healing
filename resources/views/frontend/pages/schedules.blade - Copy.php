...
<section class="about-banner position-relative overflow-hidden">
 ...
 <!-- MY ACCOUNT START -->
 <section class="yoga-course yoga-course-inner spacing-100 pb-0" style="display: none;">
    <div class="container-fluid text-center text-md-start">
      <!-- EVENTS START -->
        <div class="row row-equl">
                <h2 class="display-2 text-center text-uppercase font-weight-700 mb-lg-4">Schedule</h2>
             <!-- EVENTS START -->
                    ...
                    <div class="col-xl-4 col-lg-6 mb-5" data-sal="slide-up" style="--sal-duration: 1s">
                        <div class="card text-center mx-2">
                            <div class="top">
                                  <img src="assets/images/loading.gif" data-src="assets/images/thumb-1.webp"
                                class="d-block w-100 lazy" alt="...">
                            </div>
                            <div class="content">
                                <div class="middle">
                                    <a href="yoga-course-single.html"><h4 class="h4 font-weight-700 text-uppercase">{{$schedule->title}}</h4></a>
                                    @php
                                       $fullDay = date('l', strtotime($schedule->scheduledate));
                                       $dateInt = date('jS Y', strtotime($schedule->scheduledate));
                                       //dd($new_date);
                                    @endphp
                                    <p>{{$fullDay}} {{$dateInt}}</p>
                                    <h5 class="m-0 text-white" style="font-family:unset;">
                                ...
                                <div class="bottom w-100 d-sm-flex align-items-end justify-content-center">
                                    <a href="{{route('page.schedule.detailed', $schedule->id)}}" class="btn me-3 w-100">View</a>
...
<section class="yoga-course yoga-course-inner spacing-100 pb-0">
   <div class="container-fluid text-center text-md-start" style="max-width:99%;">
      <div class="container" style="max-width:100%;background: #373c4f;">
      <div class="content" style="display:flex;padding:0!important;">
         <div class="left">
           <div class="calendar">
             <div class="month">
...
$(document).ready(function(){
  $.ajax({
        ...
        success:function(data){
          //var eventsArr = JSON.stringify(data);
          ...
          // var datas = data.eventsItems;
          // datas = datas;
          // $.each(data.eventsItems, function (i,v)
          // {
          //   console.log(v);
