...
@section('meta_keyword', 'Subscription success')
@section('meta_description', 'Subscription success')
    ...
    <div class="container-fluid text-center text-xl-start">
        <div class="row">
            <div class="col-12 text-center">
                ...
                <h1 class="display-3 text-white text-center text-uppercase font-weight-700">Your payment was successful</h1>
