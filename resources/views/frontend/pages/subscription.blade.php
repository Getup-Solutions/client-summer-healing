...
@section('content')
@section('title', 'Subscription - '.$subscription->title)
@section('meta_keyword', 'Subscription')
@section('meta_description', 'Subscription')
<!-- PAGE HEADING START -->
 ...
 <section class="spacing-150">
    <div class="container-fluid text-center">
      ...
      @if(!auth()->check())
        ...
        $currentSubscription = $user->subscription_id;
        ...
        <div class="row">
          ...
          <div class="col-12 mt-5">
            ...
            <form name="ajax-sub-form" id="ajax-sub-form" method="post" action="{{route('page.subscription.send', $subscription->id) }}#success_order">
                @csrf
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        ...
                        <input type="hidden" name="subscription" value="{{ $subscription->title }}">
       ...
       @else
       <h1>You already have this one in your purchase list. <br> Please choose another subscription.</h1>
       <a href="{{route('user.myaccount')}}#subscriptionsSection" id="alreadyPurchased" class="btn btn-sm btn-primary">My Account</a>
       @endif
       @endif
        ...
        <div class="modal-content p-4">
            ...
            <div class="modal-body">
                ...
                <div id="login" class="activetabcontent tabcontentItem">
                    ...
                    <form action="{{ route('page.subscription.login') }}" method="POST" id="handleAjax">
                        @csrf
                ...
                <div id="register" class="tabcontentItem">
                    ...
                    <form action="{{ route('page.subscription.register') }}" method="POST" id="handleAjax2" autocomplete="off">
                        @csrf
                            <div class="form-group">
                                {{-- <label>Name</label> --}}
