...
@section('meta_keyword', 'Training')
@section('meta_description', 'Training')
<!-- PAGE HEADING START -->
    ...
    <div class="container-fluid text-center">
        ...
        <div class="row">
          ...
          <div class="col-12 mt-5">
            ...
            <h4>Amount: {{ $training->price == 0 ? "Free" : "$".$training->price }}</h4>
            <br/><br/>
            <form name="ajax-sub-form" id="ajax-sub-form" method="post" action="{{route('page.training.send', $training->id) }}#success_order">
                @csrf
