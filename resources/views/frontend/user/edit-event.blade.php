...
@section('meta_keyword', 'Edit event')
@section('meta_description', 'Edit event')
...
<div class="row index-minus text-center text-xl-start">
    <div class="col-xl-8 mx-auto">
        ...
        <form action="{{route('user.updateevent', $event->id)}}" method="POST" class="form" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="create-event">
                ...
                <div class="form-item">
                    ...
                    <div class="form-floating w-100">
                        <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="Title" value="{{ $event->title }}"/>
                ...
                <div class="form-item">
                    ...
                    <div class="form-floating w-100">
                        <input type="text" id="price" name="price" class="form-control @error('price') is-invalid @enderror" placeholder="Price" value="{{ $event->price }}"/>
                ...
                <div class="form-item">
                    ...
                    <div class="form-floating w-100">
                        <input type="text" class="form-control @error('venue') is-invalid @enderror" id="venue" name="venue" placeholder="Venue" value="{{ $event->venue }}"/>
                ...
                <div class="form-item">
                    ...
                    <div class="w-100">
                        <div class="input-group w-100 row">
                            <div class="col-md-6">
                            <input type="date" id="startdate" name="startdate" placeholder="Click to pick date" class="form-control border-right-0" value="{{ $event->startdate }}"/>
                            @error('startdate')
                                <div class="formAlertError alert alert-danger">{{ $message }}</div>
                            @enderror
                            </div>
                            <div class="col-md-6">
                            <input type="date" name="enddate" id="enddate" placeholder="Click to pick date" class="form-control" value="{{ $event->enddate }}"/>
                            @error('enddate')
                                <div class="formAlertError alert alert-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <div class="form-item">
                    ...
                    <div class="w-100">
                        <div class="input-group w-100 row">
                            <div class="col-md-6">
                                <input type='text' name="starttime" placeholder="Click to pick time" id="myDatePicker" class="myDatePicker1 form-control" value="{{ $event->starttime }}"/>
                                @error('starttime')
                                    <div class="formAlertError alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                <input type='text' name="endtime" placeholder="Click to pick time" id="myDatePicker2" class="myDatePicker2 form-control" value="{{ $event->endtime }}"/>
                                @error('endtime')
                                    <div class="formAlertError alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="form-item">
                    ...
                    <div class="w-100 d-sm-flex align-items-center justify-content-between">
                        <div class="form-floating w-49">
                            <input type="text" id="buttontext" name="buttontext" class="form-control border-right-0 set-radius-right" placeholder="Label" value="{{ $event->buttontext }}"/>
                            <label for="floatingInput">Label</label>
                        </div>
                        <div class="form-floating w-49">
                            <input type="text" id="buttonlink" name="buttonlink" class="form-control rounded-top-left-0 set-radius-left" placeholder="Link" value="{{ $event->buttonlink }}"/>
                ...
                <div class="form-item">
                    ...
                    <div class="form-group text-center mt-4 w-100">
                        <button class="mx-auto btn btn-primary">Update</button>
                    </div>
                </div>
                <!-- FORM ITEM START -->
            </div>
