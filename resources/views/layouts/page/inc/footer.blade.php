@php
$copyright = DB::table('admingeneralsettings')->pluck('copyright');
@endphp
<!-- FOOTER START -->
<footer>
         ...
         <div class="col-12">
            <div class="content d-md-flex align-items-center justify-content-between">
               ...
               <div class="links text-center text-md-start d-md-flex align-items-center justify-content-start">
                  <a href="{{ route('page.terms') }}" class="me-1 me-md-0">Terms</a>
                  <a href="{{ route('page.privacy') }}" class="me-1 me-md-0">Privacy policy</a>
                  <a href="{{ route('page.refund') }}">Refund policy</a>
               </div>
               <div class="copyright mt-2 mt-md-0 d-md-flex align-items-center justify-content-end">
                  <p class="text-center text-md-start">{{ $copyright[0] }}</p>
               </div>
            </div>
         </div>
      </div>
