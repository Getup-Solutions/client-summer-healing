...
<div class="offcanvas offcanvas-end mobile-menu" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1"

id="mobileMenu" aria-labelledby="offcanvasScrollingLabel">
...
<div class="offcanvas-body p-0">
   ...
   <div class="container-fluid">
      ...
      <div class="top">
         ...
         @endif
            <!--<a href="{{ route('page.contact') }}">Public notice</a>-->
      ...
      <div class="bottom">
         ...
         <div class="content d-md-flex align-items-center justify-content-between">
            ...
            <div class="copyright mt-2 mt-md-0 d-md-flex align-items-center justify-content-end">
               ...
               <p class="text-center text-md-start">All Rights Reserved {{date('Y')}}</p>
